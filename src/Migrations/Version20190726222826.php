 ...
 */
final class Version20190726222826 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE beer (id INT AUTO_INCREMENT NOT NULL, country_id_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, published_at DATETIME DEFAULT NULL, price NUMERIC(5, 2) NOT NULL, INDEX IDX_58F666ADD8A48BBD (country_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
