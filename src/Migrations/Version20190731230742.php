 ...
 */
final class Version20190731230742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE beer CHANGE country_id_id country_id_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE beer_id beer_id INT DEFAULT NULL, CHANGE published_at published_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE client DROP FOREIGN KEY FK_C7440455BCF5E72D');
        $this->addSql('ALTER TABLE client DROP FOREIGN KEY FK_C7440455D0989053');
        $this->addSql('DROP INDEX IDX_C7440455BCF5E72D ON client');
        $this->addSql('DROP INDEX IDX_C7440455D0989053 ON client');
        $this->addSql('ALTER TABLE client DROP beer_id, DROP categorie_id, DROP number_beer, CHANGE weight weight NUMERIC(4, 1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE beer CHANGE country_id_id country_id_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE beer_id beer_id INT DEFAULT NULL, CHANGE published_at published_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE client ADD beer_id INT DEFAULT NULL, ADD categorie_id INT DEFAULT NULL, ADD number_beer INT DEFAULT NULL, CHANGE weight weight NUMERIC(4, 1) DEFAULT \'NULL\'');
        ...
        $this->addSql('CREATE INDEX IDX_C7440455D0989053 ON client (beer_id)');
